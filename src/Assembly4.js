...
export default function Model(props) {
	...
	console.log(nodes.Solid11.geometry.boundingBox);
	return (
		<group
			ref={group}
			{...props}
		...
		>
			...
			<mesh
				...
				onPointerDown={console.log('hello')}
			...
			>
				<meshStandardMaterial
					...
					transparent={true}
					opacity={snap.items.Solid11 ? 0.5 : 0}
				/>
			</mesh>
			<mesh
			...
			>
				<meshStandardMaterial
					...
					color={hover ? 'pink' : 'blue'}
					transparent={true}
					opacity={snap.items.Solid23 ? 1 : 0}
				/>
			</mesh>
			<mesh
			...
			>
				<meshStandardMaterial
					...
					color={hover ? 'pink' : 'blue'}
					transparent={true}
					opacity={snap.items.Solid33 ? 0.5 : 0}
				/>
			</mesh>
			<mesh
			...
			>
				<meshStandardMaterial
					...
					color={hover ? 'pink' : 'blue'}
					transparent={true}
					opacity={snap.items.Solid7 ? 0.5 : 0}
				/>
			</mesh>
			<mesh
			...
			>
				<meshStandardMaterial
					...
					color={hover ? 'pink' : 'blue'}
					transparent={true}
					opacity={snap.items.Solid8 ? 0.5 : 0}
				/>
			</mesh>
			<mesh
			...
			>
				<meshStandardMaterial
					...
					color={hover ? 'pink' : 'blue'}
					transparent={true}
					opacity={snap.items.Solid9 ? 0.5 : 0}
				/>
			</mesh>
			<mesh
			...
			>
				<meshStandardMaterial
					...
					color={hover ? 'pink' : 'blue'}
					transparent={true}
					opacity={snap.items.Solid10 ? 1 : 0}
				/>
			</mesh>
			{/* <mesh
				material={nodes.Solid11.material}
